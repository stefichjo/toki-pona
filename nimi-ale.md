...
| <img src="musi/pona/pini.png" height="50" title="pinis"><br>**pini** | [**<sub><sup>AREA</sup></sub>**](#area) <br><sub><sup>ADJECTIVE</sup></sub> **completed**, *done*, **ended**, **finished**: (*~~pi sike/tenpo~~ pini*) **ago**, *last*, **past**, *previous*; <br><sub><sup>VERB</sup></sub> *(pini e ~~open~~) to close* <br><sub><sup>NOUN</sup></sub> *end*: (*lon pini*) *after*, *in the end*, (*tan pini*) *since* |
