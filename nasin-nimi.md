...
| <img src="musi/pona/kulupu.png" height="50" title="kulupu"><br>**kulupu** | [**ᴛʜɪɴɢ**](#thing) <br>ᴀᴅᴊᴇᴄᴛɪᴠᴇ (*~~pi kulupu~~ sama* = *sama*) **fellow**, *in common*, *shared*: (*jan ~~pi kulupu~~ sama* = *jan sama*) **peer**, (*jan ~~pi kulupu mama~~ sama* = *jan sama* = *~~pata~~*) **sibling** <br>ɴᴏᴜɴ *relationship*; (*kulupu ~~jan~~*) **community**, **company**, **group**, **nation**, **society**, **tribe**; (⇐ *lawa*) *arrangement*, *organization*; (⇐ *mute*) *trio*; *multitude*, *set* |
...
| <img src="musi/pona/mute.png" height="50" title="multe"><br>**mute** | [**ᴛʜɪɴɢ**](#thing) <br>ᴀᴅᴊᴇᴄᴛɪᴠᴇ [**3+**](pu.md#lesson-12), [**20**](pu.md#lesson-12), **a lot**, **many**, **several**; <br>ᴀᴅᴠᴇʀʙ **much**, **very**; (*mute ~~sin~~*) **more**; <br>ᴠᴇʀʙ [**to multiply**](pu.md#toki-pona-proverbs) <br>ɴᴏᴜɴ *amount*, **quantity** |
| | [**ɴᴜᴍʙᴇʀ**](#number) <br>ᴀᴅᴊᴇᴄᴛɪᴠᴇ (*~~tuli~~*) *3*, *three*; <br>ɴᴏᴜɴ (⇒ *kulupu*) |
