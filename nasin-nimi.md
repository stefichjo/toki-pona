...
| <img src="musi/pona/lukin.png" height="50" title="luk-im"> | [**ᴛᴏᴏʟ**](#tool) + [**ᴀᴜxɪʟɪᴀʀʏ**](#auxiliary) **lukin**, *pilin* <br>ɴᴏᴜɴ **eye** (⇐ *~~oko~~*) → <br>ᴠᴇʀʙ **to look at**, **see**; (*lukin ~~wawa~~*) **examine**, **observe**, **read**, [**search**](sonja.md#preface), **watch** + <br>ᴀᴜxɪʟɪᴀʀʏ **to seek** *to*, [**seek to**](sonja.md#lesson-13), **try to**; (*lukin jo*) [**to look for**](sonja.md#errata) <br>ᴠᴇʀʙ *to care for* |
