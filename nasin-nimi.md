...
| | [**ɴᴏᴜɴ ᴀᴅᴊᴇᴄᴛɪᴠᴇ: ᴀʀᴇᴀ**](#area) <br>ᴀᴅᴊᴇᴄᴛɪᴠᴇ **enduring**, **kept**; (*~~pi tenpo~~ awen*) *present*; (*~~pi nanpa~~ awen*) *current*; (*awen ~~lon~~*) **staying**; (⇐ *open*) **waiting**; (⇐ *tomo*) **protected**, **safe**; <br>ᴠᴇʀʙ (⇐ *tomo*) [**to help in peril**](pu.md#short-obligatory-prayer), [**protect**](pu.md#lesson-15) | <br>ɴᴏᴜɴ (⇒ *tenpo*)
