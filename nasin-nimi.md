...
| | [**ɴᴏᴜɴ ᴀᴅᴊᴇᴄᴛɪᴠᴇ: ᴀʀᴇᴀ**](#area) <br>ᴀᴅᴊᴇᴄᴛɪᴠᴇ **enduring**, **kept**; (*~~pi tenpo~~ awen*) *present*; (*~~pi nanpa~~ awen*) *current*; (*awen ~~lon~~*) **staying**; (⇐ *open*) **waiting**; (*tomo*); <br>ᴠᴇʀʙ (*tomo*) | <br>ɴᴏᴜɴ (⇒ *tenpo*)
