...
pu la jan ken kama sona e nasin toki pi toki pona. taso tenpo mute la pu taso la jan ken ala kama sona e ale pi toki pona. lipu ni li lukin pana e sona sin ale. ijo pi kama tan sona sin ni li jo e sitelen  `Ü`.
*(Interagante kun la oficiala libro de Tokipono oni povas lerni la gramatikon de Tokipono. Sed ofte simple "pu"-ante oni ne povas lerni ĉion pri Tokipono. Ĉi tiu dokumento provas instrui la reston. Derivaĵoj de tiuj aldonaj priskriboj havas la signon `Ü`.)*
...
sitelen insa li lon monsi pi kulupu pi [nimi suli](#nimi-suli).
*(Punkto sekvas frazon.)*

* telo li pona***.*** *(Akvo estas bona.)*

kulupu pi [nimi suli](#nimi-suli) li jo e nimi "seme", la sitelen "seme" li lon monsi.
...
kulupu pi [nimi suli](#nimi-suli) tu li kama wan, la sitelen kulupu li lon insa pi ona tu.
*(Se du frazoj fariĝas unu, komo estas inter ili.)*

* ona li mama ala, li jo ala e mama. *(Ŝi ne estas gepatro kaj ne havas gepatron.)*

nimi "a" en nimi "mu" li nimi kalama. ona li sama kulupu sin pi [nimi suli](#nimi-suli). taso pu la ona li [nimi ilo](#nimi-ilo). tan ni la sitelen kulupu li lon ala lon insa ona.
...
kulupu pi nimi "la" la sitelen palisa li kama sitelen kulupu.
...
*(Laŭ la oficiala libro de Tokipono, substantivo (aŭ verbo) kaj modifilo unuiĝas al unu hieroglifo. En tiu ĉi dokumento, modifilo povas havi ligostrekon.)*
...
* mi lukin tawa sina. *(Mi serĉas vin.)*
...
* sona e *(scianta, konanta)*
* toki e *(diranta, komunikanta)*
* unpa e *(seksumanta)*
* utala e *(konfliktanta, batalanta)*
...
nimi ilo "en" li lon insa pi [nimi ijo](#nimi-ijo) tu pi ijo lon tu.
*(La partikulo "en" estas inter du radikaj vortoj pri du efektivaĵoj.)*

* pan **en** telo *(pano kaj akvo)*
...
* mi pali lon ni: mi lon tomo. → ~~lon ni,~~ mi lon tomo, **la** mi pali. *("Mi laboras ĉe ke mi estas ĉe la domo." → Se mi estas ĉe la domo, mi laboras.)* `Ü`
...
**nimi "pi"** li insa pi [nimi lawa](#nimi-lawa) tu.
...
* ~~ijo~~ sike *(cirklo, sfero, kuglo ← rondaĵo)*
...
kepeken nimi lon monsi pi **nimi lawa weka "ma"** la jan ken sin e [nimi monsi palisa](#nimi-monsi-palisa).
*(Per loka substantivo, oni povas modifi prepozicion.)*
...
*(Laŭ la oficiala libro de Tokipono, "ale" povas signifi "tre multe".)*
...
*(Laŭ la oficiala libro de Tokipono, "nanpa" povas esti partikulo. Tiel, "pi" inter "nanpa" kaj "mute" mankas.)*
...
*(Laŭ la oficiala libro de Tokipono, numeralo povas esti partikulo kun alia numeralo. Tial, ne estas la partikulo "en" inter du numeraloj. Tiel, du numeraloj estas kiel unu nova numeralo. Tial, ne estas "pi" antaŭ ili.)*

* kili **pi** tu **en** wan → kili tu wan *(tri fruktoj)*

___
* ~~mute pi ijo~~ ala *(nul ← kvanto de io nula)*
* ~~mute pi ijo~~ ale *(cent ← kvanto de io tuta)*
...
* ~~ilo~~ poki *(ingo, ujo ← enhavilo)* `Ü`
* ~~ilo~~ uta *(buŝo ← kisilo)* `Ü`
...
* ~~sijelo~~ kala *(fiŝo, delfeno, baleno ← naĝa vivaĵo)* `Ü`
* ~~sijelo~~ kasi *(planto ← kreska vivaĵo)* `Ü`
* ~~sijelo~~ pipi *(insekto ← rampa vivaĵo)* `Ü`
* ~~sijelo~~ soweli *(mamulo ← varmsanga/ĉarma vivaĵo)* `Ü`
...
___
* ~~kule~~ jelo *(flava)*
* ~~kule~~ laso *(verda, blua)*
* ~~kule~~ loje *(ruĝa)*
* ~~kule~~ pimeja *(malhela, nigra)*
* ~~kule~~ walo *(hela, blanka)*
...
| tawa ala *(nenien, por nenio)*   | tawa ale *(ĉien, por ĉio)*       | tawa ni *(tien, por tio)*        | tawa seme *(kien, por kio)*      |
| tan ala *(de nenie, nenial)*     | tan ale *(de ĉie, ĉial)*         | tan ni *(de tie, tial)*          | tan seme *(de kie, kial)*        |
| lon tenpo-ala *(neniam)*         | lon tenpo-ale *(ĉiam)*           | lon tenpo-ni *(tiam)*            | lon tenpo-seme *(kiam)*          |
| lon nasin-ala *(neniel)*         | lon nasin-ale *(ĉiel)*           | lon nasin-ni *(tiel)*            | lon nasin-seme *(kiel)*          |
...
*("seme" estas kiel radika vorto. Sed laŭ la oficiala libro de Tokipono, ĝi estas partikulo.)*
